	  ...
	  <a href="/" class="navbar-brand"><img src="img/LogoReal.png" width="126" height="50" alt="Hazzers"></a>
		...
		<div class="collapse navbar-collapse">
			<ul class="navbar-nav ml-auto">
				...
				@else
				<li class="nav-item">
					<a href="/cart" class="nav-link btn btn-outline-primary">
				...
				<li class="nav-item dropdown">
					<a href="#" class="nav-link dropdown-toggle" id="dropdownMenuLink" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
